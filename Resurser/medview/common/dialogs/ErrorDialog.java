 ...
 * @(#)ErrorDialog.java
 *
 * $Id: ErrorDialog.java,v 1.8 2010/06/28 08:46:17 oloft Exp $
 *
 * --------------------------------
...
public class ErrorDialog extends AbstractDialog implements MedViewMediaConstants, MedViewLanguageConstants
{
	...
	{
		return TITLE_ERROR_LS_PROPERTY;
	}
	...
	protected JPanel createMainPanel()
	{
		...
		JLabel errorImage = new JLabel(mVDH.getImageIcon(ERROR_IMAGE_ICON_40));
		...
		if (message == null)
		{
			message = "No exception message specified";
		}
