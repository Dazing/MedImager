/*
 * @(#)MeduwebIntervalNode.java
 *
 * $Id: MeduwebIntervalNode.java,v 1.1 2003/07/21 21:55:07 d99figge Exp $
 *
 * --------------------------------
...
public class MeduwebIntervalNode extends MeduwebTranslatedNode
{
	public boolean parseNode( ) throws CouldNotParseNodeException
	{
		try
		{
			...
			String translation = model.getTranslation(values[0]);
	...
	public MeduwebIntervalNode( String termName ) { super(termName); }
