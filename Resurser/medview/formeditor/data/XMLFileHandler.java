 ...
 *
 * $Id: XMLFileHandler.java,v 1.1 2003/11/10 23:38:43 oloft Exp $
 *
 */
    ...
    public void saveExamination(File xmlFile, ExaminationModel examination) throws IOException {
        ...
        for (int cat = 0; cat < categories.length; cat++) {
            ...
            for (int input = 0; input < inputs.length; input++) {
                ...
                if (inputs[input].getType() == InputModel.TYPE_TEXTAREA) {
        ...
        for (int i=0; i < categoryNodeList.getLength(); i++) {
            ...
            for (int c = 0; c < children.getLength(); c++) {
                ...
                if (nodename.equals("NAME")) { // Set the category name
                    ...
                    int newFieldType = FieldModel.TYPE_SINGLE;
                    ...
                    for (int inpC = 0; inpC < inputChildren.getLength(); inpC++){
                        ...
                        if (name.equals("TYPE")) {
                            ...
                            if (value.equals("TEXTAREA")) {
                                ...
                                inputType = InputModel.TYPE_TEXTAREA;
                           /* } else if (value.equals("PICTURECHOOSER")) {
                            ...
                            if (fieldT.equals("SINGLE"))
                                newFieldType = FieldModel.TYPE_SINGLE;
                            else if (fieldT.equals("MULTI"))
                                newFieldType = FieldModel.TYPE_MULTI;
                            else if (fieldT.equals("NOTE"))
                                newFieldType = FieldModel.TYPE_NOTE;
                            else if (fieldT.equals("INTERVAL"))
                                newFieldType = FieldModel.TYPE_INTERVAL;
                            else if (fieldT.equals("QUESTION"))
                                newFieldType = FieldModel.TYPE_QUESTION;
                            else if (fieldT.equals("IDENTIFICATION")){
                                newFieldType = FieldModel.TYPE_IDENTIFICATION;
                            }
                            else {
                  ...
                  /*  String[] presets =  DatahandlingHandler.getInstance().getPresets(inputName);
                   ...
                   // presets[0] = "";
                    ...
                    switch(inputType) {
                        case InputModel.TYPE_TEXTAREA:
                            FieldModel    fModel = new CreatorFieldModel(inputName, newFieldType, presetModel, inputDesc, "", FieldModel.DEFAULT_LENGTH);
