...
public class TraumaNextVisitInputComponent extends TeethInputComponent {
    ...
    protected JPanel createInputPanel()
    {
        ...
        String[] labelStrings = {   "Tandens färg: ", "Mobilitet: ", "Perkussionsöm: ", "Avvikande perkussionsljud: ",
                                    "Ocklusionskontakt: ", "Fistel: ", "Gingivit: ",
                                    "Gingiva retraktion: ", "Sens test: ", "Patologisk ficka: ",
                                    "Röntgen - pulpakanal obliteration: ", "Röntgen - periradikulära förändringar: ", "Röntgen - rotresorption: "};

        String[] labelTreatmentStrings = { "Avlägsnande av fixering: ", "Rotbehandling: ", "Dentin täckning: ", "Extraktion: "};
        String[][] comboTreatmentStrings = {    {"","Nej", "Ja"},
                                                {"","Primär rensning","Fortsatt rensning","Rotfyllning"},
