 ...
 *
 * $Id: TreeFileHandler.java,v 1.79 2006/05/29 18:32:48 limpan Exp $
 *
 * $Log: TreeFileHandler.java,v $
 * Revision 1.79  2006/05/29 18:32:48  limpan
 * Added minimed code
 * ----------------------------------------------------------------------
 *
 * Revision 1.78  2006/04/24 14:17:31  lindahlf
 * <No Comment Entered>
 *
...
public class TreeFileHandler implements medview.datahandling.examination.ExaminationDataHandler,
	MedViewDataConstants
{
    ...
    */
	...
	try {
		...
		try {
		    String file_pcode = getPCode(files[i]);
    ...
    */
   public medview.datahandling.examination.ExaminationValueContainer getExaminationValueContainer(ExaminationIdentifier id, int hint)
