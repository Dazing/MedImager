 ...
 *
 * $Id: ParsedTermDataHandler.java,v 1.28 2010/05/06 19:19:17 oloft Exp $
 *
 * --------------------------------
					...
					try
					{
						...
						synchronized(ParsedTermDataHandler.this) // lock object during write (see top)
						{
							...
							for (int ctr1=0; ctr1<keyArray.length; ctr1++)
							{
                                ...
                                stringbuf.append(TERM_DEFINER + keyArray[ctr1] + "\r\n");
								...
								for (int ctr2=0; ctr2<currentVector.size(); ctr2++)
								{
                                    ...
                                    stringbuf.append(currentVector.elementAt(ctr2) + "\r\n");
                                }
